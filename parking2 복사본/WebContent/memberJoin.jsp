...
<body>
	...
	<form method="post" action="regulerJoinComplete.lim">
		...
		<div>	
			<label class="btn active">						
				<input type="radio" name="hybird_car" value="true" checked>하이브리드 등록
			</label>
			<label class="btn">
				<input type="radio" name="hybird_car" value="false" checked>아니다
			</label>
		</div>				
