...
<a href="sessionLogout.jsp">로그아웃</a>
		...
		<form method="post" action="mamont.jsp" style="margin-left:20px;">
		   		<label>분당 금액 : </label><input type="text"  placeholder="초기값 1,000원" name="mamont" maxlength="25" style="margin-left:20px;">
				<input type= submit value="금액 변경" style="margin-left:10px;">
				<input type= hidden name ="ID1" value="${ID1}">
				<input type= hidden name ="Password1" value="${Password1}">
			</form>
			<form method="post" action="mamont2.jsp" style="margin-left:20px;">
		   		<label>월 금액 : </label><input type="text"  placeholder="초기값 100,000원" name="Mamont" maxlength="25" style="margin-left:20px;">
				<input type= submit value="금액 변경" style="margin-left:10px;">
				<input type= hidden name ="ID1" value="${ID1}">
				<input type= hidden name ="Password1" value="${Password1}">
			</form>
